...
import { DynamoDBService } from '../utils/aws-wrapper-services/index.ts'
import { Constants } from '../constants/index.ts'

import { generate } from "https://deno.land/std@0.160.0/uuid/v1.ts";
...
export class ChristmasMarketsService {
  ...
  public async b2cCreateChristmasMarket(transformedEvent: InputModels.B2CCreateMarket): Promise<ResponseModels.Response> {
    ...
    const item = { ...transformedEvent.requestBody, marketApproved: false, marketId: generate(), userId: transformedEvent.pathParameters.userId }
    try {
